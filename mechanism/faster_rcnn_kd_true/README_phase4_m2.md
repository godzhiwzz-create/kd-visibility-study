...
## Server-side launch
```bash
nohup /root/miniconda3/bin/python3 /root/kd_visibility/faster_rcnn_kd_true/faster_rcnn_m2_guard.py \
...
- State file: `/root/kd_visibility/faster_rcnn_kd_true/phase4_m2_state.json`
- Summary CSV: `/root/kd_visibility/faster_rcnn_kd_true/phase4_m2_results.csv`
