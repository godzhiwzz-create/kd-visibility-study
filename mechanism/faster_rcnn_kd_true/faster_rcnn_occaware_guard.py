...
WAIT_STATE = WORK_ROOT / 'mechanism' / 'm13_dense_check' / 'm13_dense_state.json'
...
RUNNER = '/root/kd_visibility/mechanism/faster_rcnn_kd_true/run_faster_rcnn_occaware_queue.py'
