...
\begin{itemize}
    ...
    \item We identify occlusion, as a specific and measurable component of visibility degradation, as the most directly supported factor among those tested, and use a supplementary occlusion-control experiment to further substantiate this M2 interpretation;
...
Beyond the specific KD research community, this study addresses a practical concern in intelligent transportation and all-weather visual perception systems. Model compression through KD is frequently required for deploying detection networks on edge devices with limited computational resources; understanding why KD fails under visibility degradation is essential for building robust perception pipelines that operate reliably across varying environmental conditions \cite{chen2023towards, wang2024robust}. From this perspective, the paper contributes not only to detection methodology but also to the broader domain of image communication and visual perception robustness \cite{guo2021meets, liu2023learning}.
