...
WAIT_STATE = WORK_ROOT / 'scripts/yolo_dense_mechanism_checks' / 'm13_dense_state.json'
...
RUNNER = '/root/kd_visibility/scripts/faster_rcnn_boundary_check/run_faster_rcnn_occaware_queue.py'
